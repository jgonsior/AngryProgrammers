...
public interface MovesDAO {
    ...
    void save(@Bind("gameId") int gameId, @Bind("birdNumber") int birdNumber, @Bind("fromState") int fromState, @Bind("action") int action, @Bind("toState") int toState, @Bind("reward") double reward, @Bind("randAction") boolean randomAction, @Bind("trajectoryType") String trajectoryType);
