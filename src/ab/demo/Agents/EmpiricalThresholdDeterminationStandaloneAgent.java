 ...
 */
public class EmpiricalThresholdDeterminationStandaloneAgent extends StandaloneAgent {
    private static final Logger logger = Logger.getLogger(EmpiricalThresholdDeterminationStandaloneAgent.class);
