...
public class ConnectedComponent {
    ...
    public ABType assignType(int vision_type) {
        ...
        switch (vision_type) {
            case ImageSegmenter.PIG:
                type = ABType.Pig;
                break;
            case ImageSegmenter.STONE:
                type = ABType.Stone;
                break;
            case ImageSegmenter.WOOD:
                type = ABType.Wood;
                break;
            case ImageSegmenter.ICE:
                type = ABType.Ice;
                break;
            case ImageSegmenter.HILLS:
                type = ABType.Hill;
                break;
            case ImageSegmenter.RED_BIRD:
                type = ABType.RedBird;
                break;
            case ImageSegmenter.YELLOW_BIRD:
                type = ABType.YellowBird;
                break;
            case ImageSegmenter.BLUE_BIRD:
                type = ABType.BlueBird;
                break;
            case ImageSegmenter.BLACK_BIRD:
                type = ABType.BlackBird;
                break;
            case ImageSegmenter.WHITE_BIRD:
                type = ABType.WhiteBird;
                break;
            default:
                type = ABType.Unknown;
        }
